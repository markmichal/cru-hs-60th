...
>
> **Latest (2026-06-27, no owner action):** the share.html media input was overhauled (auto-detect pasted links, either/or one-media-per-story) and **all videos now embed in-site including Vimeo** — pure front-end, goes live on the Pages rebuild. See "2026-06-27 — media input overhaul + Vimeo embedding".
>
